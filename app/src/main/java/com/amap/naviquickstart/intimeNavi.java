...
public class intimeNavi extends AppCompatActivity implements View.OnClickListener, LocationSource, AMapLocationListener, AMapNaviListener {
    private static final String TAG = "intimeNavi";
